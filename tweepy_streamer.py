...
class Tweet_Analyser:
    '''
    Functionality for analysing and categorising contents from tweet
    '''
...
if __name__ == "__main__":
    ...
    df['analyser'] = np.array([tweet_analyzer.analyze_sentiment(tweet) for tweet in df['Tweets']]) 
